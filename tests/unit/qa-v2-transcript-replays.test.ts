...
describe('qa-v2 transcript replays', () => {
  ...
  it('replays household correction and maternity scenario overrides without falling back to stale maternity detail', async () => {
    await replayTranscript(
      [
        {
          user: "what's a coverage tier?",
  ...
  it('replays BCBSTX definitions directly even from dental context', async () => {
    await replayTranscript(
      [
        {
