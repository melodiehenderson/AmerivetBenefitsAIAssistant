...
describe('qa-v2 engine', () => {
  ...
  it('gives a sharper term-versus-whole decision framework for generic life choice wording before family split context is established', async () => {
    const session = makeSession({
      step: 'active_chat',
      userName: 'Charlie',
      hasCollectedName: true,
  ...
  it('gives a sharper term-first framework for generic life amount wording before family split context is established', async () => {
    const session = makeSession({
      step: 'active_chat',
      userName: 'Charlie',
      hasCollectedName: true,
  ...
  it('treats "what are those medical premiums again" wording as a direct medical pricing pivot even from life context', async () => {
    const session = makeSession({
      step: 'active_chat',
      userName: 'Ted',
      hasCollectedName: true,
    ...
    const result = await runQaV2Engine({
      query: 'what are those medical premiums again?',
      session,
    });
  ...
  it('replays short deictic plan-price wording back into medical from disability when recent assistant history already established medical pricing', async () => {
    ...
    const result = await runQaV2Engine({
      query: 'can i just see those plan prices again?',
      session,
    });
