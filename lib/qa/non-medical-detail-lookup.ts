...
function buildLifeDecisionFrameworkReply(query: string, session: Session): string | null {
  const lower = query.toLowerCase();
  const asksDirectLifeDecision = /\b(which\s+one\s+should\s+i\s+get|which\s+ones\s+should\s+i\s+get|which\s+of\s+those\s+should\s+i\s+get|which\s+should\s+i\s+get|which\s+should\s+i\s+prioritize|what\s+should\s+i\s+prioritize|what\s+should\s+i\s+start\s+with|which\s+one\s+should\s+i\s+start\s+with|what'?s\s+the\s+smarter\s+move|what\s+is\s+the\s+smarter\s+move|which\s+one\s+makes\s+more\s+sense|what\s+makes\s+more\s+sense|what\s+do\s+you\s+recommend|would\s+you\s+recommend|what\s+would\s+you\s+recommend|how\s+much\s+should\s+i\s+get|how\s+much\s+coverage\s+should\s+i\s+get|how\s+much\s+would\s+you\s+recommend|what\s+amount\s+would\s+you\s+recommend|how\s+much\s+protection\s+is\s+worth\s+paying|how\s+should\s+i\s+split\s+that|how\s+do\s+i\s+split\s+that|what\s+mix\s+makes\s+sense)\b/i.test(lower);
