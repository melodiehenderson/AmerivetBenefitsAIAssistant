...
export const AMERIVET_MEDICAL_PLAN_SUMMARIES: MedicalPlanSummary[] = [
  {
    ...
    primaryCare: 'No fixed copay modeled; care generally runs through deductible first, then coinsurance',
    specialist: 'No fixed copay modeled; care generally runs through deductible first, then coinsurance',
    urgentCare: 'No fixed urgent care copay modeled in the structured summary',
    emergencyRoom: 'No fixed emergency room copay modeled in the structured summary',
    inNetworkCoinsurance: '20% after deductible',
    outOfNetworkCoinsurance: '40% after deductible',
    physicalTherapy: 'Not modeled as a separate flat copay; likely follows the plan medical deductible and coinsurance structure',
    maternity:
    ...
    prescriptionDrugs: {
      ...
      specialty: null,
      note: 'The Rx tier breakdown is not yet structured in this plan-summary layer.',
    },
  ...
  },
  {
    ...
    specialist: '$40 copay',
    urgentCare: '$75 copay',
    emergencyRoom: 'Emergency room copay not separately structured in the current plan-summary layer',
    inNetworkCoinsurance: '15% after deductible where applicable',
    outOfNetworkCoinsurance: '40% after deductible',
    physicalTherapy: 'Not modeled as a separate flat copay in the current plan-summary layer',
    maternity:
  ...
  },
  {
    ...
    primaryCare: '$20 copay',
    specialist: '$45 copay',
    urgentCare: 'Urgent care copay not separately structured in the current plan-summary layer',
    ...
    physicalTherapy: 'Subject to Kaiser plan rules; not separately modeled in the current plan-summary layer',
    maternity:
